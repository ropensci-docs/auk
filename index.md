...
[`auk_ebd()`](https://docs.ropensci.org/auk/reference/auk_ebd.md). Then
...
[`vignette("auk")`](https://docs.ropensci.org/auk/articles/auk.md).

## Code of Conduct

Please note that this project is released with a [Contributor Code of
Conduct](https://docs.ropensci.org/auk/CONDUCT.md). By participating in
