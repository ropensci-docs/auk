...
[`auk_ebd()`](https://docs.ropensci.org/auk/reference/auk_ebd.md) and
filters can be defined using the various other functions in this
package, e.g.
...
[auk_ebd](https://docs.ropensci.org/auk/reference/auk_ebd.md) object,
this function will filter both the eBird Basic Dataset and the sampling
data using the same set of filters. This ensures that the files are in
sync, i.e. that they contain data on the same set of checklists.
