...
[`read_ebd()`](https://docs.ropensci.org/auk/reference/read_ebd.md) uses
`stringsAsFactors = FALSE`, `quote = ""`, sets column classes, and
...
filters
#> Input 
#>   EBD: /github/home/R/x86_64-pc-linux-gnu-library/4.6/auk/extdata/zerofill-ex_ebd.txt 
#>   Sampling events: /github/home/R/x86_64-pc-linux-gnu-library/4.6/auk/extdata/zerofill-ex_sampling.txt 
#> 
#> Output 
#>   Filters not executed
#> 
